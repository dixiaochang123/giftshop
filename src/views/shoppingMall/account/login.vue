<template>
  <div class="account-box" :style="{ backgroundImage: 'url(' + require('@/assets/img/slices/banner-2.png') + ')' }">
    <div class="account-form">
      ...
      <!-- 短信登陆 -->
      <div class="account-inner" v-show="current == 0">
      ...
      <div class="account-inner" v-show="current == 1">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
          <el-form-item required prop="phone">
            <div class="form-cell">
              <div class="value">
                <el-input v-model="ruleForm.phone" maxlength="11" placeholder="账号"></el-input>
              </div>
            </div>
          </el-form-item>
          <el-form-item required prop="code">
            <div class="form-cell">
              <div class="value">
                <el-input v-model="ruleForm.code" maxlength="6" placeholder="密码"></el-input>
              </div>
            </div>
          </el-form-item>
        </el-form>
